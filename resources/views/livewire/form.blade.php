<form class="mt-8">
    ...
    <div class="mt-4">
        ...
        <textarea wire:model="message" class="w-full border-gray-300 rounded-lg" style="height:150px;" id="message"
            class="block w-full mt-1" type="text" name="message" required></textarea>
    </div>
    @error('message')
        <span class="text-sm text-red-600">{{ $message }}</span>
    @enderror
    ...
    <div class="mt-4">
        ...
        <select wire:model="department" name="department" id="department"
            ...
            <option value="admin">General Department</option>
